            ...
            child:Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    Text("Today Classes",
                          style:TextStyle(color:textPrimaryColor,fontWeight: FontWeight.w500,fontSize: 20),),
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>TimeTableView()));
                      },
                      child: Text("See all",
                            style: TextStyle(color: primaryColor,fontWeight: FontWeight.w200,fontSize: 14),),
                    )
                  ],
                ),
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      return model.classes[index].day==model.day?  Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(model.classes[index].startTime+" - "+model.classes[index].endTime,style: 
                                  TextStyle(color: textSecondaryColor,fontSize: 14,fontWeight: FontWeight.w200),),
                            SizedBox(height:5),
                            Text(model.classes[index].className,style: 
                                  TextStyle(color: textPrimaryColor,fontWeight: FontWeight.w500,fontSize: 16),)
                          ],
                        ),
                      ):SizedBox();
                    }
