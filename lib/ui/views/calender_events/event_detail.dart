                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(event.eventName,style: 
                      TextStyle(fontWeight: FontWeight.bold,fontSize: 24,color: textPrimaryColor),),
                    )  ,
                    SizedBox(height: 10,),
                    Padding(
                      padding: const EdgeInsets.only(left:15.0,right: 10),
                      child: Text(event.description,style: TextStyle(color:textSecondaryColor,fontSize: 18),),
                    )            
                  ],
                ),
