...
class MultiCircularLoader extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;
  ...
  @override
  _MultiCircularLoaderState createState() => _MultiCircularLoaderState();
}

class _MultiCircularLoaderState extends State<MultiCircularLoader>
