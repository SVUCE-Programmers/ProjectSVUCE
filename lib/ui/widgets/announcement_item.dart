...
class AnnounceItem extends StatelessWidget {
  ...
  const AnnounceItem({Key key, this.announce,this.type,this.uiHelpers}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return type=="all"?Container(
     decoration: uiHelpers.textFieldDecoration,
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text(announce.type,style: TextStyle(fontSize: 10,fontWeight: FontWeight.w200),),
          ),
          uiHelpers.verticalSpaceLow,
          Text(announce.desc,style: TextStyle(fontSize: 14,fontFamily: "Quicksand",fontWeight: FontWeight.w300,)),
          uiHelpers.verticalSpaceLow,
          Text( _firestore.getTimeAgo(DateTime.parse(announce.timeStamp)) ,
          style: TextStyle(fontWeight: FontWeight.w200,fontSize: 10),),
        ],
      ),     
    ):
    announce.type==type? Container(
     decoration: uiHelpers.textFieldDecoration,
      padding: EdgeInsets.all(20.0),
      margin: EdgeInsets.symmetric(vertical: 10.0), 
      child: Column(
